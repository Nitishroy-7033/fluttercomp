...
class AlignAndPaddingPage extends StatelessWidget {
  const AlignAndPaddingPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        PageAppBar(
          pageName: "Align and Padding Section",
        ...
        MasonryView(
          listOfItem: align_and_paddingList,
