...
import '../../ComponentsList/form/form_list.dart';
import '../../ComponentsList/onboarding/onboarding_screen_list.dart';
...
class OnboardingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        PageAppBar(
          pageName: "Onboarding Page Section",
        ...
        MasonryView(
          listOfItem: OnboardingScreenList,
